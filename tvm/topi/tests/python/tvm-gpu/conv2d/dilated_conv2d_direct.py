...
def conv2d(N, H, W, CI, CO, KH, KW, strides, padding, scaling_factor):
    ...
    conv = tvm.compute(oshape, lambda n, oc_chunk, oh, ow, oc_block:
                       tvm.sum(pad_data[n, ic_chunk, oh*stride_h+kh*dilation, ow*stride_w+kw*dilation, ic_block]
                               .astype('int32') *
...
N, H, W, CO, CI, KH, KW, strides, padding, scaling_factor = 1, 14, 14, 256, 256, 3, 3, (1, 1),(1,1),1.0
...
c_np = np.zeros((N, CO//BO, 12, 12, BO), dtype='int8')
